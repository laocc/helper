...
function is_card(string $code): bool
{
    ...
    $prov = substr($code, 0, 2);
    $proA = [11, 12, 13, 14, 15, 21, 22, 23, 31, 32, 33, 34, 35, 36, 37, 38, 41, 42, 43, 44, 45, 46, 50, 51, 52, 53, 54, 61, 62, 63, 64, 65, 71, 81, 82];
    if (!in_array($prov, $proA)) return false;
